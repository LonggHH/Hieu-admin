...
// page Hiu
const TransitOperator = React.lazy(() => import('./views/pages/TransitOperator'))
const TransportMode = React.lazy(() => import('./views/pages/TransportMode'))
const Line = React.lazy(() => import('./views/pages/Line'))
const Stop = React.lazy(() => import('./views/pages/Stop'))
const Route = React.lazy(() => import('./views/pages/Route'))
...
const DeviceManage = React.lazy(() => import('./views/pages/DeviceManage'))
...
const routes = [
  ...
  // 
  { path: '/transitoperator', name: 'Transit Operator', element: TransitOperator },
  { path: '/transportmode', name: 'Transport Mode', element: TransportMode },
  { path: '/line', name: 'Line', element: Line },
  { path: '/stop', name: 'Stop', element: Stop },
